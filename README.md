...
| `timeoutFailSecs?` (in seconds) | `number`                 | `5`         | Tthe maximum time to wait for the `onPrevChunk` and `onNextChunk` functions, if the timeout is exceeded, the onError event will occur |
